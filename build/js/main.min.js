...
var mainFormTel = _modules_data_js__WEBPACK_IMPORTED_MODULE_2__["mainForm"].querySelector('input[type="tel"]');
_modules_data_js__WEBPACK_IMPORTED_MODULE_2__["aboutText"].classList.remove('about__show-text');

var mainFormTelHandler = function mainFormTelHandler(evt) {
  evt.preventDefault();
...
var callButtonHandler = function callButtonHandler(evt) {
  evt.preventDefault();
...
_modules_data_js__WEBPACK_IMPORTED_MODULE_2__["mainForm"].addEventListener('submit', function (evt) {
  evt.preventDefault();
...
_modules_data_js__WEBPACK_IMPORTED_MODULE_2__["aboutButton"].addEventListener('click', function () {
  _modules_data_js__WEBPACK_IMPORTED_MODULE_2__["aboutText"].classList.toggle('about__show-text');
  _modules_data_js__WEBPACK_IMPORTED_MODULE_2__["aboutButton"].textContent = _modules_data_js__WEBPACK_IMPORTED_MODULE_2__["aboutButton"].textContent === _modules_data_js__WEBPACK_IMPORTED_MODULE_2__["ABOUTBUTTONTEXT"][0] ? _modules_data_js__WEBPACK_IMPORTED_MODULE_2__["ABOUTBUTTONTEXT"][1] : _modules_data_js__WEBPACK_IMPORTED_MODULE_2__["ABOUTBUTTONTEXT"][0];
});
...
var hideAccordionSection = function hideAccordionSection() {
  _data__WEBPACK_IMPORTED_MODULE_0__["accordionControls"].forEach(function (element) {
...
var accordionHandler = function accordionHandler(evt) {
...
var makeAccordion = function makeAccordion() {
...
/*!****************************!*\
  !*** ./js/modules/data.js ***!
  \****************************/
/*! exports provided: body, header, callButton, modal, closeModalButton, modalArea, modalSubmitButton, checkbox, aboutText, REGION, modalForm, mainForm, mainSubmitButton, aboutButton, ABOUTBUTTONTEXT, HIDESECTION, MOBILEVIEWPORT, WIDEVIEWPORT, accordionControls, accordion */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ABOUTBUTTONTEXT", function() { return ABOUTBUTTONTEXT; });
...
var REGION = '+7';
var ABOUTBUTTONTEXT = ['Свернуть', 'Подробнее'];
var HIDESECTION = 'accordion__control--hide-section';
var MOBILEVIEWPORT = '768';
var WIDEVIEWPORT = '1024';
var body = document.querySelector('body');
var header = body.querySelector('header');
var callButton = body.querySelector('.callback-button');
var modal = body.querySelector('.modal');
var closeModalButton = modal.querySelector('.modal__close-button');
var modalArea = modal.querySelector('.modal__feedback');
var modalForm = modal.querySelector('.modal__feedback-form');
var modalSubmitButton = modalForm.querySelector('.modal__feedback-submit');
var checkbox = modalForm.querySelector('input[type="checkbox"]');
var aboutText = document.querySelector('.about__text-container');
var mainForm = body.querySelector('.feedback__form');
var mainSubmitButton = mainForm.querySelector('.feedback-form__submit');
var about = body.querySelector('.about');
var aboutButton = about.querySelector('.about__button');
var accordionControls = body.querySelectorAll('.accordion__control');
var accordion = body.querySelector('.accordion');
...
var fillNumber = function fillNumber(val) {
  var swapValue = '';
  swapValue = val.replace(/\D/gm, '');
  swapValue = swapValue[0] !== '7' ? "".concat(_data__WEBPACK_IMPORTED_MODULE_0__["REGION"]).concat(swapValue) : "+".concat(swapValue);
  swapValue = swapValue.replace(swapValue.substring(0, 2), function (str) {
    return str + '(';
  });

  if (swapValue.length >= 6) {
    swapValue = swapValue.replace(swapValue.substring(0, 6), function (str) {
      return str + ')';
    });
  }
...
var maskHandler = function maskHandler(input) {
...
/* harmony import */ var _inputmask_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../inputmask.js */ "./js/modules/inputmask.js");



var inputName = _data_js__WEBPACK_IMPORTED_MODULE_0__["modal"].querySelector('input[name="name"]');
var modalScrollWidth = Object(_utils_utils_js__WEBPACK_IMPORTED_MODULE_1__["getScrollWidth"])();
var modalFormTel = _data_js__WEBPACK_IMPORTED_MODULE_0__["modalForm"].querySelector('input[type="tel"]');

var modalFormTelHandler = function modalFormTelHandler(evt) {
  evt.preventDefault();
  Object(_inputmask_js__WEBPACK_IMPORTED_MODULE_2__["maskHandler"])(evt.target);
};

modalFormTel.addEventListener('input', modalFormTelHandler);

var modalHandler = function modalHandler(evt) {
  evt.stopPropagation();
...
var modalSubmitHandler = function modalSubmitHandler(evt) {
  evt.preventDefault();
...
var showModal = function showModal() {
  ...
  _data_js__WEBPACK_IMPORTED_MODULE_0__["body"].style.paddingRight = "".concat(modalScrollWidth, "px");
...
var closeModal = function closeModal() {
  ...
  _data_js__WEBPACK_IMPORTED_MODULE_0__["body"].style.paddingRight = 0;
...
/*!***************************!*\
  !*** ./js/utils/utils.js ***!
  \***************************/
/*! exports provided: getScrollWidth */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getScrollWidth", function() { return getScrollWidth; });
/* harmony import */ var _modules_data_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/data.js */ "./js/modules/data.js");


var getScrollWidth = function getScrollWidth() {
  var div = document.createElement('div');
  _modules_data_js__WEBPACK_IMPORTED_MODULE_0__["body"].append(div);
  var width = div.offsetWidth;
  div.style.position = 'fixed';
  div.style.width = '100vw';
  var widthWithScroll = div.offsetWidth;
  var scrollWidth = widthWithScroll - width;
  div.remove();
  return scrollWidth;
};
